...
## Install chaincode on peers of all organizations
infoln "Installing chaincode on peer0.water_quality_data , updating and retrievals,storage..."
installChaincode 0 water_quality_data , updating and retrievals,storage

infoln "Installing chaincode on peer1.water_quality_data , updating and retrievals,storage..."
installChaincode 1 water_quality_data , updating and retrievals,storage

infoln "Installing chaincode on peer2.water_quality_data , updating and retrievals,storage..."
installChaincode 2 water_quality_data , updating and retrievals,storage

infoln "Installing chaincode on peer0.government..."
installChaincode 0 government

infoln "Installing chaincode on peer1.government..."
installChaincode 1 government

infoln "Installing chaincode on peer2.government..."
installChaincode 2 government

infoln "Installing chaincode on peer0.incentives_contrants..."
installChaincode 0 incentives_contrants

infoln "Installing chaincode on peer1.incentives_contrants..."
installChaincode 1 incentives_contrants

infoln "Installing chaincode on peer2.incentives_contrants..."
installChaincode 2 incentives_contrants


## query whether the chaincode is installed
queryInstalled 0 water_quality_data , updating and retrievals,storage

## approve the definition for water_quality_data , updating and retrievals,storage
approveForMyOrg 0 water_quality_data , updating and retrievals,storage

## approve the definition for government
approveForMyOrg 0 government

## approve the definition for incentives_contrants
approveForMyOrg 0 incentives_contrants
...
checkCommitReadiness 0 water_quality_data , updating and retrievals,storage
checkCommitReadiness 0 government
checkCommitReadiness 0 incentives_contrants
...
queryCommitted 0 water_quality_data , updating and retrievals,storage
queryCommitted 0 government
queryCommitted 0 incentives_contrants
