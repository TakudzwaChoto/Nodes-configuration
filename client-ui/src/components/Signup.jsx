                ...
                <div>
                    ...
                    <div className="mt-1  text-slate-700">
                        ...
                        py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'>
                            <option value="water_quality_data , updating and retrievals,storage">water_quality_data , updating and retrievals,storage</option>
                            <option value="government">government</option>
                            <option value="incentives_contrants">incentives_contrants</option>
