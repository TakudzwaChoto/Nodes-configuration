export const DEFAULT_ORG = 'WaterQuality';
...
export const API_PAT_END_POINT = 'http://localhost:3001/participant'
export const API_ADD_PARTICIPANT = API_PAT_END_POINT + '/add';
export const API_UPDATE_PARTICIPANT = API_PAT_END_POINT + '/update';
export const API_SEARCH_PARTICIPANT = API_PAT_END_POINT + '/search';
export const API_GET_ALL_PARTICIPANTS = API_PAT_END_POINT + '/getall';
